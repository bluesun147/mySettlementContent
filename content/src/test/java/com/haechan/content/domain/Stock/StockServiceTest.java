...
import com.haechan.content.domain.stock.service.OptimisticLockStockFacade;
...
class StockServiceTest {
    ...
    public void before() {
        ...
        Ost ost = ostRepository.findById(1L).orElseThrow();

        Stock stock = new Stock(1L, ost, 100L);
