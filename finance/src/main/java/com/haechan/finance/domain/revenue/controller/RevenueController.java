package com.haechan.finance.domain.revenue.controller;

import com.haechan.finance.domain.revenue.entity.Revenue;
import com.haechan.finance.domain.revenue.service.RevenueService;
...
public class RevenueController {
    ...
    public String uploadFile(@RequestParam(name="file") MultipartFile file) {
        ...
        return "redirect:/finance/revenue/list?page=0";
    }
}
