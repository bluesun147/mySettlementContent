...
import com.haechan.finance.domain.config.TestQueryDslConfig;
import com.haechan.finance.domain.revenue.entity.QRevenue;
...
import static com.haechan.finance.domain.revenue.entity.QRevenue.revenue;
...
//    }
    ...
    public void testFindByThisMonth() {
        ...
        assertEquals(1, resultPage.getContent().size()); // 페이지 크기가 10인지 확인 (페이징 정보에 따라 다를 수 있음)
    }
